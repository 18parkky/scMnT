...
- Scanpy object where cell type information is available at .obs['CellType'] and cell barcodes (e.g., TAGTTGGCAGGTCCAC-1) must be available at .obs.index. Please ensure that each cell type has enough number of cells (>100).
