...
def main():
    ...
    # Load heavy packages
    import getAlleleTable, scMnT_score, scMnT_find, scMnT.scMnT_utility as scMnT_utility
    ...
    scMnT_find.runscMSI_find( adata, mininum_loci, filename, DIR_out )
    
    logging.info(f"Finished scMnT\t(Total time taken: {scMnT_utility.getElapsedTime(start_time)} seconds)")
